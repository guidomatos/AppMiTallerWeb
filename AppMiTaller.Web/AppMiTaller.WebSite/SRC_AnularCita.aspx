    ...
    <script type="text/javascript">
        ...
        function fn_edicionDatosCliente(blnEditar) {
            ...
            if (!blnEditar) {
                ...
                $("#lblCliDoc,#lblCliNombre,#lblCliTelFijo,#lblCliTelCel,#lblTextoEmail2,#lblTextoEmail3").css("display", "block");

                $("#btnGrabarCliente,#btnCancActualiza,#txtCliEmail,#txtCliEmailAlter,#txtCliEmailTrab").css("display", "none");
                $("#lblCliEmail,#lblCliEmailAlter,#lblCliEmailTrab,#btnActCliente").css("display", "block");
            }
            else {
                $("#txtCliEditNom,#txtCliEditApeP,#txtCliEditApeM,#txtCliCodTelFijo").css("display", "block");
                $("#lblCliNombre").css("display", "none");
                $("#txtCliNombre").css("display", "none");

                $("#txtCliDoc,#txtCliTelFijo,#txtCliTelCel").css("display", "block");
                $("#lblCliDoc,#lblCliNombre,#lblCliTelFijo,#lblCliTelCel").css("display", "none");

                $("#btnGrabarCliente,#btnCancActualiza,#txtCliEmail,#txtCliEmailTrab,#txtCliEmailAlter").css("display", "block");
